...
function vowelCount(str){
    ...
    // for (let i=0;i<str.length;i++){
        // if (str[i].toLowerCase() in ['a','e','i','o','u']){
            // vowels[str[i].toLowerCase()] +=1;
        // }
    // }
    const vowels = 'aeiou';
    splitArr.forEach(function(c){
...
function doubleValuesWithMap(arr) {
    return arr.map(function(val){
        return val*2; //or doubled(val) where --> function doubled(number){return number*2}
    })
}
